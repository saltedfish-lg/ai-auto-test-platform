...
def main():
    ...
    args=ap.parse_args()
    api=yaml.safe_load((args.root/"编码权威事实/OPENAPI/openapi.yaml").read_text(encoding="utf-8"))
    ...
    client=["/* Generated from current docs/authority OpenAPI. DO NOT EDIT. */",
    ...
    report={"authority_model":"SINGLE_LIVING_AUTHORITY","authority_root":"docs/authority","schema_types":len(comps),"client_methods":count,"outputs":["types.ts","client.ts"]}
