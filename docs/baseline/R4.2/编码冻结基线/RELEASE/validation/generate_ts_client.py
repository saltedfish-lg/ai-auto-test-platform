...
def main():
    ...
    lines=["/* Generated from PDBR-2026.08.07-R4.2 OpenAPI. DO NOT EDIT. */",""]
    for name,s in comps.items():
        lines.append(f"export type {name} = {ts_type(s,name)};")
    (out/"types.ts").write_text("\n\n".join(lines)+"\n",encoding="utf-8")
    imports=", ".join(comps.keys())
    client=["/* Generated from PDBR-2026.08.07-R4.2 OpenAPI. DO NOT EDIT. */",
    ...
    report={"release_id":"PDBR-2026.08.07-R4.2","schema_types":len(comps),"client_methods":count,"outputs":["types.ts","client.ts"]}
